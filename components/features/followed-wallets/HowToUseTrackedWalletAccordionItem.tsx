...
function HowToUseTrackedWalletAccordionItem() {
  return (
    <AccordionItem className="text-sm md:text-base my-1" value={"how to use"}>
      ...
      <AccordionContent forceMount className="px-4 py-8 text-left">
        ...
        <p className="text-muted-foreground">
          ...
          wallet activities, track transactions, and gain insights into
          profitable strategies used by smart money investors. By tracking key
          wallets, you can identify trends, analyze trading behaviors, and make
          data-driven investment decisions in real-time. Step-by-Step Guide to
          Using Tracked Wallets
        </p>
        ...
        >
          ...
          <li>
            Ensure you&apos;re logged in to save and manage your tracked
            wallets.
          </li>
        </ul>
        <h5 className="font-bold text-lg mt-2">
        ...
        >
          <li>
            Once added, you can view real-time activities of the tracked
            wallets, including:
          ...
          <li>
            Each wallet also displays messages or notes, providing deeper
            insights into their trading strategies and decision-making patterns.
          </li>
        </ul>
        <h5 className="font-bold text-lg mt-2">
        ...
        >
          ...
          <li>
            Trending Traders & Pairs: Identify popular wallets and the most
            traded tokens to spot opportunities early.
          </li>
          <li>
        ...
        <p className="text-muted-foreground">
          ✅ Improve Trading Strategies – Learn from successful traders and
        ...
        <p className="text-muted-foreground">
          ✅ Manage Risk Effectively – Understand wallet behaviors and avoid
          risky trades.
        </p>
...
export default HowToUseTrackedWalletAccordionItem;
